...
class CategoryTest extends WebTestCase
{
    ...
    public function testCategoryPageWorks(): void
    {
        ...
        $client->request('GET', $urlGeneratorInterface->generate('category.index', ['slug' => $category->getSlug()]));
    ...
    public function testpaginationWorks(): void
    {
        ...
        $crawler = $client->request('GET', $urlGeneratorInterface->generate('category.index', ['slug' => $category->getSlug()]));
